...
{
    public class FinancingsContractedFee
    {
        /// <summary>
        ...
        /// <summary>
        /// É o valor da tarifa em percentual pactuada no contrato. [Restrição] Preenchimento obrigatório quando a forma de cobrança for Percentual.Exemplo: 0.0150 = 1,5%.
        /// </summary>
        [Required]
