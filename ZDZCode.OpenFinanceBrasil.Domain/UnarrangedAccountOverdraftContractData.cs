...
namespace ZDZCode.OpenFinanceBrasil.Domain
{
    ...
    /// </summary>
    public class UnarrangedAccountOverdraftContractData
    {
        /// <summary>
        ...
        /// </summary>
        [Required]
        public List<UnarrangedAccountOverdraftContractInterestRate> InterestRates { get; set; }

        /// <summary>
        /// Lista que traz a relação de tarifas pactuadas no contrato.
        /// </summary>
        [Required]
        public List<UnarrangedAccountOverdraftContractedFee> ContractedFees { get; set; }

        /// <summary>
        /// Lista que traz os encargos pactuados no contrato
        /// </summary>
        [Required]
        public List<UnarrangedAccountOverdraftFinanceCharge> ContractedFinanceCharges { get; set; }
    }
}
