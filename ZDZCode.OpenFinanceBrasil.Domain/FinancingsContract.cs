...
namespace ZDZCode.OpenFinanceBrasil.Domain
{
    ...
    public class FinancingsContract
    {
        ...
        /// </summary>
        [Required]
        public EnumContractProductTypeFinancings ProductType { get; set; }
        ...
        /// </summary>
        [Required]
        public EnumContractProductSubTypeFinancings ProductSubType { get; set; }
        ...
        /// </summary>
        [Required]
        public List<FinancingsContractInterestRate> InterestRates { get; set; }

        /// <summary>
        /// [Objeto que traz o conjunto de informações necessárias para demonstrar a composição das taxas de juros remuneratórios da Modalidade de crédito].
        /// </summary>
        [Required]
        public List<FinancingsContractedFee> ContractedFees { get; set; }

        /// <summary>
        /// Lista que traz os encargos pactuados no contrato.
        /// </summary>
        [Required]
        public List<FinancingsFinanceCharge> ContractedFinanceCharges { get; set; }
    }
}
