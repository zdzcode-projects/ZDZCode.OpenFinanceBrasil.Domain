...
{
    public class GetRiskPensionContractData
    {
        /// <summary>
        ...
        /// <summary>
        /// Indicar a categoria do Produto: 1-Tradicional, 2-Microsseguro
        /// </summary>
        ...
        /// <summary>
        /// Lista a ser preenchida pelas participantes quando houver 'Outros' no campo 'Tipo de Assistência'.
        /// </summary>
        ...
        /// <summary>
        /// A considerar os seguintes domínios: true, false
        /// </summary>
        [Required]
        public bool GlobalCapital { get; set; }

        /// <summary>
        /// [Define o prazo do plano contratado Vitalícia, Temporária - prazo fixo, Temporária – intermitente
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// [Listagem de regime financeiro para cada combinação de modalidade/cobertura do produto indicando: 1. Repartição simples. 2. Repartição Capitais Cobertura. 3. Capitalização]
        /// </summary>
        public List<InsurancePensionEnumFinancialRegime> FinancialRegimeContractTypes { get; set; }
        ...
        /// <summary>
        /// [1. Saldamento, 2. Benefício Prolongado, 3. Não se aplica]
        /// </summary>
        ...
        /// <summary>
        /// [Modalidade de pagamento da indenização, a considerar os domínios abaixo: 1. Único, 2. Sob a forma de renda]
        /// </summary>
        ...
        ///
        /// </summary>
        public RiskPensionMinimumRequirement MinimumRequirement { get; set; }
