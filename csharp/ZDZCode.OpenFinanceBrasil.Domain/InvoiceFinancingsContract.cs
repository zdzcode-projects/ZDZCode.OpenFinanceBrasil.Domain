...
{
    public class InvoiceFinancingsContract
    {
        /// <summary>
        ...
        /// </summary>
        [Required]
        public EnumContractProductTypeInvoiceFinancings ProductType { get; set; }
        ...
        /// </summary>
        [Required]
        public EnumContractProductSubTypeInvoiceFinancings ProductSubType { get; set; }
        ...
        /// </summary>
        [Required]
        public List<InvoiceFinancingsContractInterestRate> InterestRates { get; set; }

        /// <summary>
        /// [Objeto que traz o conjunto de informações necessárias para demonstrar a composição das taxas de juros remuneratórios da Modalidade de crédito]
        /// </summary>
        [Required]
        public List<InvoiceFinancingsContractedFee> ContractedFees { get; set; }

        /// <summary>
        /// Lista que traz os encargos pactuados no contrato.
        /// </summary>
        [Required]
        public List<InvoiceFinancingsFinanceCharge> ContractedFinanceCharges { get; set; }
    }
}
