...
namespace ZDZCode.OpenFinanceBrasil.Domain
{
    public class HomeInsuranceData
    {
        ...
        /// </summary>
        [Required]
        public List<HomeCoverageItem> Coverages { get; set; }

        /// <summary>
        ///
        /// </summary>
        [Required]
        public List<HomePropertyCharacteristics> PropertyCharacteristics { get; set; }
        ...
        /// <summary>
        /// Texto livre para complementar informação relativa ao additional, quando for selecionada a opção 'Outros'
        /// </summary>
